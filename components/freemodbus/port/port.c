...
static UCHAR ucMasterPortMode = 0;
...
UCHAR
ucMBPortGetMode( void ) // TODO renamed based on EQ-703
{
    return ucPortMode;
}

void
vMBPortSetMode( UCHAR ucMode ) // TODO renamed based on EQ-703
{
